...
NProgress_render = (fromStart) ->
    progress = document.getElementById('Spin')
    if progress
      return progress
    addClass document.documentElement, 'Spin-busy'
    ...
    if parent != document.body
        addClass parent, 'Spin-custom-parent'
...
NProgress_remove = ->
    removeClass document.documentElement, 'Spin-busy'
    removeClass BODY, 'Spin-custom-parent'
    progress = document.getElementById('Spin')
